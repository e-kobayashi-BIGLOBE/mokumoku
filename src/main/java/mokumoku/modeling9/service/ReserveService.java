    ...
    class 予約Repository {
        public 予約リスト find(会議室 _会議室) {
            ...
            if (_会議室.equals(会議室.B)) {
                // 会議室B予約あり 12/1 13:00-14:00, 12/1 14:00-16:00
                予約 _会議室B予約1 = new 予約(
                ...
                予約 _会議室B予約2 = new 予約(
                        new 予約時間(開始時間.create("20181201140000"), 終了時間.create("20181201160000")),
                        new 予約者("ほげ川ほげたろう"),
                        会議室.B
                );

                return new 予約リスト(List.of(_会議室B予約1,_会議室B予約2));
            }
